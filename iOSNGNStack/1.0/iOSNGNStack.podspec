...
This is iOS wrapper for Doubango, we will use it as good as we can.
  ...
  s.frameworks = 'OpenGLES', 'QuartzCore', 'Foundation', 'CFNetworking', 'CoreAudio', 'AVFoundation', 'AudioUnit', 'AudioToolbox', 'AddressBook', 'CoreGraphics', 'CoreVideo', 'CoreMedia', 'AddressBookUI', 'SystemConfiguration'
